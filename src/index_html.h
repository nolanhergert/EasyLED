...
<label>Choose a function:
  <select name="function">
    ...
    <option value="0">_Combine With</option>
  ...
  <div class="slidecontainer">Number of LEDs:
	...
	<label>Pattern: 
	  <select name="pattern">
		...
		<option value="1">Fill Noise</option>
		<option value="2">Juggle</option>
...
document.getElementsByName("function")[0].addEventListener('change', (event) => {
  ...
  // Refactor this list to be an array of string name, customizer? Generate html
